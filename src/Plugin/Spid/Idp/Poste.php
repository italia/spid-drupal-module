 ...
 * )
 */
class Poste implements IdpInterface {

  /**
   * {@inheritdoc}
   */
  public function getId() {
    return 'spid-idp-posteid';
  }
  ...
  public function getConfig() {
    return [
      ...
      'singleSignOnService' => [
        'url' => 'https://posteid.poste.it/jod-fs/sloservicepost',
      ],
      'singleLogoutService' => [
  ...
  public function getLogo($type = 'png') {
    switch ($type) {
      case 'png':
        return 'spid-idp-posteid.png';

      case 'svg':
        return 'spid-idp-posteid.svg';
